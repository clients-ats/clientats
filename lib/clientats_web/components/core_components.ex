defmodule ClientatsWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ClientatsWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClientatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClientatsWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  @doc """
  Renders a comprehensive error recovery panel with fallback options.
  ...
  def error_recovery_panel(assigns) do
    ~H"""
    <div class={"border-l-4 border-red-500 bg-red-50 p-4 rounded-lg #{@class || ""}"}>
      <!-- Error Header -->
      <div class="flex items-start gap-3 mb-4">
        <div class="flex-shrink-0">
          <.icon name="hero-exclamation-circle" class="w-6 h-6 text-red-600" />
        </div>
        <div class="flex-1">
