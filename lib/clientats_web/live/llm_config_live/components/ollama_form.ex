  ...
  def render(assigns) do
    ...
    <div class="space-y-4">
      ...
      <%= if length(@ollama_models) > 0 do %>
        <div class="form-control">
          <label class="label">
            <span class="label-text font-semibold">Default Model <span class="badge badge-sm badge-success">Required</span></span>
        ...
        <div class="form-control">
          ...
          <span class="label-text-alt text-gray-600">Used for text-only tasks when you want to use a faster or lighter model. Falls back to Default Model if not specified.</span>
        </div>
      ...
      <div class="alert alert-info">
        ...
        <div>
          ...
          <ul class="text-sm list-disc list-inside space-y-1">
            <li><a href="https://ollama.ai" target="_blank" class="link link-primary">Download and install Ollama</a> on your local machine</li>
            <li>Start the Ollama server (default: <code class="text-xs bg-gray-100 px-1 rounded">http://localhost:11434</code>)</li>
            <li>Pull models: <code class="text-xs bg-gray-100 px-1 rounded">ollama pull mistral</code> or <code class="text-xs bg-gray-100 px-1 rounded">ollama pull qwen2.5vl</code></li>
