  ...
  def render(assigns) do
    ...
    <div class="space-y-4">
      <div class="form-control">
        ...
        />
        <span class="label-text-alt text-gray-600">Get your API key from <a href="https://aistudio.google.com/apikey" target="_blank" class="link link-primary">Google AI Studio</a></span>
      ...
      <div class="form-control">
        <label class="label">
          <span class="label-text font-semibold">Default Model <span class="badge badge-sm badge-success">Recommended: gemini-2.5-flash</span></span>
        ...
        <span class="label-text-alt text-gray-600">Used for text extraction and general processing. Falls back to Vision Model when image analysis is needed.</span>
      </div>

      <div class="form-control">
        <label class="label">
          <span class="label-text font-semibold">Vision Model <span class="badge badge-sm">Optional</span></span>
        ...
        <span class="label-text-alt text-gray-600">Used when document images or visual content needs to be analyzed. Leave empty to use Default Model for vision tasks.</span>
      </div>

      <div class="form-control">
        <label class="label">
          <span class="label-text font-semibold">Text Model <span class="badge badge-sm">Optional</span></span>
        ...
        <span class="label-text-alt text-gray-600">Used for text-only tasks when you want to use a faster or cheaper model. Falls back to Default Model if not specified.</span>
      </div>
      ...
      <div class="alert alert-info">
        ...
        <div>
          ...
          <ul class="text-sm list-disc list-inside space-y-1">
            ...
            <li>Enable the Generative AI API in your <a href="https://console.cloud.google.com" target="_blank" class="link link-primary">Google Cloud Console</a></li>
            <li>Available models: gemini-2.5-pro, gemini-2.5-flash (recommended), gemini-2.0-flash, gemini-1.5-pro</li>
